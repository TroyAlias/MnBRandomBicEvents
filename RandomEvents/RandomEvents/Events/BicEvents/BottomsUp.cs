...
namespace CryingBuffalo.RandomEvents.Events
{
	public sealed class BottomsUp : BaseEvent
	{
		...
		public BottomsUp() : base(Settings.ModSettings.RandomEvents.BirdSongsData)
		{
			...
			minMoraleGain = MCM_MenuConfig_A_M.Instance.BU_minMoraleGain;
			maxMoraleGain = MCM_MenuConfig_A_M.Instance.BU_maxMoraleGain;
			minGold = MCM_MenuConfig_A_M.Instance.BU_minGold;
			maxGold = MCM_MenuConfig_A_M.Instance.BU_maxGold;
		}
		...
		{
			return MCM_MenuConfig_A_M.Instance.BU_Disable == false && MobileParty.MainParty.CurrentSettlement != null && (MobileParty.MainParty.CurrentSettlement.IsTown && CampaignTime.Now.IsNightTime && Clan.PlayerClan.Renown >= 500||
				 MCM_MenuConfig_A_M.Instance.BU_Disable == false && MobileParty.MainParty.CurrentSettlement != null && MobileParty.MainParty.CurrentSettlement.IsVillage) && CampaignTime.Now.IsNightTime && Clan.PlayerClan.Renown >= 500;
		}
		...
		public override void StartEvent()
		{
			...
			var eventDescription = new TextObject("{=BottomsUp_Event_Text}While in {currentSettlement} you decide to make your way to the tavern with a few of your men for a night of fun and games." +
				"  After a few drinks a young man begins boasting his drinking abilities, declaring himself the king of this tavern.  'No man can outdrink me!' he declares.  Your men turn to you and " +
				"smile, wondering if you will take this boy up on his claim.")
			...
			var eventOption2 = new TextObject("{=BottomsUp_Event_Option_1}Decline").ToString();
			var eventOption2Hover = new TextObject("{=BottomsUp_Event_Option_1_Hover}Best not to interfere").ToString();
			...
			var eventMsg1 = new TextObject(
					"{=Refugees_Event_Msg_1}You won!  Earning {gold} gold!")
			...
			var eventOptionBText = new TextObject(
				   "{=BottomsUp_Event_Choice_1}You look up at your men and give a little smirk, knowing full well you could have crushed this boy's dreams but sometimes it's best to let others have their moment.")
			   .ToString();

			var eventButtonText1 = new TextObject("{=BottomsUp_Event_Button_Text}Choose").ToString();
			var eventButtonText2 = new TextObject("{=BottomsUp_Event_Button_Text}Done").ToString();
